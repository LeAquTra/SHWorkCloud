...
public enum ErrorCode {
    ...
    /**
     * 没有社区管理权限（需要 <b>管理员或超管</b>：role 1 / 9）。
     * <p>与 {@link #POST_REVIEW_FORBIDDEN} 分开：教师能审（课堂上处理学生发的内容），
     * 但"下架正在展示的内容 / 彻底删除别人的帖子"是破坏性操作，不给教师。
     * 前端据这个码可以把"管理"入口对教师隐藏（体验层），真正的拦截在这里。
     */
    POST_MANAGE_FORBIDDEN(40302, "需要管理员权限才能管理社区内容"),
